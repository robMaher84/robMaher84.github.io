//Custom fix for zurb forms.  

//targetDropDown is needed to keep track of the currently selected dropdown menu.  Otherwise keyup / down on dropdown menus breaks with dropdowns of uneven length.
var targetDropDown = $('.custom-dropdown');
(function ($, window, document, undefined) {
    ...
    Foundation.libs.forms = {
        ...
        append_custom_select: function (idx, sel) {
            ...
            if ($customSelect.length === 0) {
                ...
                }).join(' ') + '"><a href="#" class="selector ss-icon">&#x25BE;</a><ul /></div>');
    ...
    var getFirstPrevSibling = function ($el, selector) {
        //Need to check for undefined on pages that do not contain javascript.
        if ($el != undefined) {
            var $el = $el.prev();
            while ($el.length) {
